# <i class="fa-solid fa-rocket"></i> Quickstart

This is a quick reference guide to how to get started defocussing using OpenDefocus. It will contain links to more detailed descriptions, however, this should get you far enough to make some pretty images!
